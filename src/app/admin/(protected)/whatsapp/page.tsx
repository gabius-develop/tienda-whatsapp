...
interface BotConfig {
  ...
  carousel_template_name: string
  carousel_template_lang: string
}
      ...
      .then((data) => {
        if (data && data.phone_number_id) {
          setConfig({
            ...
            carousel_template_name: data.carousel_template_name ?? '',
            carousel_template_lang: data.carousel_template_lang ?? 'es',
          })
        }
      })
      .catch(() => {})
