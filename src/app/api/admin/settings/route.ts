...
const ALLOWED_KEYS = ['primary_color', 'store_name', 'logo_url', 'welcome_title', 'welcome_subtitle', 'footer_text', 'whatsapp_contact_phone', 'service_active', 'service_paused_message']
