...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-green-600 text-white hover:bg-green-700 active:bg-green-800 active:scale-95 focus:ring-green-500',
      secondary: 'bg-gray-800 text-white hover:bg-gray-900 active:bg-black active:scale-95 focus:ring-gray-500',
