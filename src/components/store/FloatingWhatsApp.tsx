  ...
  return (
    <>
      ...
      <a
        ...
        className="sm:hidden fixed bottom-20 right-4 z-50 bg-[#25D366] hover:bg-[#1ebe57] text-white w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-105"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="hidden sm:flex fixed bottom-6 left-6 z-50 bg-[#25D366] hover:bg-[#1ebe57] text-white items-center gap-2 px-5 py-3.5 rounded-2xl shadow-lg transition-transform hover:scale-105"
        aria-label="Contactar por WhatsApp"
      >
